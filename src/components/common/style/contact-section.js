...
.main-container {
    ...
    .contact-wrapper {
        ${tw`bg-primary rounded-lg shadow-xl relative`}
        ...
        .list {
            ...
            .separator {
                ${tw`w-16 h-16 rounded-full text-primary bg-white border-8 border-primary border-opacity-70 md:text-2xl text-xl font-bold flex justify-center items-center`}
            }
        }
