...
const StyledTestimonial = styled.section`
    ...
    .main-container {
        ${tw`grid md:grid-cols-2 grid-cols-1 items-center justify-center container mx-auto md:(px-8 gap-x-12 gap-y-0) gap-y-8 px-5`};
        ...
        .left {
            ...
            .custom-carousel {
                ...
                .custom-arrow {
                    ${tw`absolute md:(bottom-0 top-auto) top-0 bg-primary bg-opacity-60 z-10 md:(w-12 h-12) w-8 h-8 flex items-center justify-center rounded-md cursor-pointer`}
                ...
                .carousel-container {
                    ...
                    p {
                        ${tw`text-left text-paragraph-color font-normal md:text-xl text-lg`}
                    }
        ...
        .right {
            ...
            h2 {
                ${tw`md:text-4xl text-2xl font-black`}
            }
            ...
            .features {
                ${tw`flex md:flex-row flex-col gap-x-4 pt-4`}
