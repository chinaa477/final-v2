...
${tw`md:pt-32 pt-12 bg-primary bg-opacity-5`};
.main-container {
    ...
    .courses-list {
        ...
        .card {
            ${tw`bg-white rounded-lg shadow-2xl overflow-hidden relative`}
            ...
            .inner {
                ...
                .content {
                    ${tw`p-6 flex flex-col items-start gap-y-4`}
            ...
            .hover-content {
                ${tw`absolute top-0 left-0 w-full h-full bg-primary opacity-0 transition duration-[300ms] p-8 z-[2]`}
            }
